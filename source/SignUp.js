            ...
            <View style = {styles.view_container}>
                ...
                <LoaderDashboard loaderVal = {this.state.dayChangeLoader} />
                    ...
                    <View style={styles.contentview_container}>
                      ...
                      <View>
                    <Text style={{marginLeft:10,fontFamily:'PoppinsSemiBold',fontSize:27,color:'#000'}}> Create account </Text>
                    ...
                    <Text style={{marginLeft:-3,marginTop:3,fontSize:12,fontFamily:'PoppinsRegular'}}> I agree to all terms and conditions || </Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('PrivacyPolicy',{profilePic: '', route: 'signup'})}>
                    <Text style={{marginLeft:-3,marginTop:3,fontSize:12,fontFamily:'PoppinsRegular'}}>Privacy Policy</Text>
                    </TouchableOpacity>
                    </View>
