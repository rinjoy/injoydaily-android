...
export default class Feature2 extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            basicArray: props.basicData,
            week: props.basicData.details.week,
            day: props.basicData.details.week,
            UID: 0,
            featureType: props.dataFromParent.feature_type,
            //featureType: 1,
            premiumModal: false,
            userProfilePic: props.user_pic,
            premiumModal1: false,
            editIndex: '',
            editPost: {},
            flagModal: false,
            ...
            itemCount: 0,
            offSet:0,
            challengeArray: props.dataFromParent,
        };
    ...
    render() {
      ...
      var chlObject = {'challenge_id':this.state.challenge_id, 'week': this.state.week, 'day': this.state.day};
        return (
          ...
          <Modal style={{marginLeft: 10, marginRight: 10, marginTop: StatusBar.currentHeight}}
                 transparent={true}
            hasBackdrop = {true} isVisible={this.state.editModal} >
              <KeyboardAvoidingView
                  enabled
                  behavior='position'
                  keyboardVerticalOffset={deviceHeight/18}>
          <View style={{backgroundColor: '#fff', paddingBottom: 20, margin: 0}}>
            <View style={{padding: 0}}>
