...
export default class Feature14 extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
          <View style={{paddingVertical: 15, paddingHorizontal: 20, justifyContent: 'center', alignItems: 'center'}}>
            <Text>Content not added yet for this feature........</Text>
          </View>
