...
const bar = require('./../images/bar-4.png');
...
const injoycirclelogo = require('./../images/fullimagewithtext1.png');
const injoycirclelogoBlue = require('./../images/imagewithtext.png');
    ...
    poadCastRoute = () => {
        return (
            ...
            <ScrollView
                ...
                <Text style={{marginTop: 18, fontFamily: 'PoppinsBold', fontSize: 18}}>Latest Episode:</Text>
                ...
                return (
                    <TouchableOpacity
                        ...
                        <ImageBackground source={{uri: item.image_name}}
                                         style={{
                                             resizeMode: 'contain',
                                             height: 78, width: 78, margin: 0, shadowColor: "#000",
                                             shadowOffset: {
                                                 width: 0,
                                                 height: 1,
                                             },
        ...
        return (
            <ScrollView
                ...
                <View style={{
                    ...
                    <ImageBackground style={{height: 90, width: '100%', alignSelf: 'center'}} source={bar}>
    ...
    renderVideo() {
        ...
        return (
            list.map((item, index) => {
                ...
                return (
                    <TouchableOpacity
                        onPress={() => this.props.navigation.navigate('LibraryVideoContentSeeAll', {'DATA':{
                                'ITEMID':item.id,
                                'CHID':challangeId,
                                'TITLE':item.name
                            }})}
