...
export default class CheckItSeeAll extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            loader: false,
            accessToken: '',
            challengeId: props.navigation.state.params.DATA.challenge_id,
            categoryId: props.navigation.state.params.DATA.category_id,
            featureId: 7,
            dropDowntext: '',
            day: props.navigation.state.params.DATA.day,
            data_list: [],
            offSetLoader: true,
            uid: props.navigation.state.params.DATA.uid,
            week: props.navigation.state.params.DATA.week,
            hederTitle: '',
            countRecords: 0,
            contentData:[],
            question: '',
