...
export default class WeaklyVideo extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            featureId: 6,
            categoryId: props.navigation.state.params.challenge_details.feature_category_id,
            day: props.navigation.state.params.challenge_details.day,
            week: props.navigation.state.params.challenge_details.week,
            points: props.navigation.state.params.DATA.points,
            check_status: props.navigation.state.params.challenge_details.check_status,
            uid: '',
            commentText: '',
            offSet: 0,
            offSetLoader: true,
            ...
            weeklyVideo_title: '',
            weeklyVideo_Desc: '',
            feature_name: props.navigation.state.params.challenge_details.feature_name,
            button_text: '',
