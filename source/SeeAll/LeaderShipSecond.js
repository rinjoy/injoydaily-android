...
export default class LeaderShipSecond extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            challenge_id: props.navigation.state.params.cId,
            week: props.navigation.state.params.week,
            firstThreeFR: [],
            FirstThreeSR: [],
        }
    }
    ...
    FirstRoute = () => {
        return (
            <ScrollView style={{height: '95%', backgroundColor: "transparent", marginTop: 0}}>
                <View style={{
                    marginHorizontal: 20,
                    height: 260, backgroundColor: 'white', borderBottomRightRadius: 5, borderBottomLeftRadius: 5,
        ...
        return this.state.firstThreeFR.map((item, rowMap) => {
            ...
            return (
                <View style={{
                    ...
                    flex: rowMap == 1 ? 1.3 : 1, paddingHorizontal: 0,marginTop:12
                }}>
				<View style={{backgroundColor: 'white', alignItems: 'center'}}>
                     {rowMap == 0 &&
                        <Image source={silver} style={{position: 'absolute', top: rowMap == 1 ? -25 : 40, zIndex: 99, height: 30, width: 30}}></Image>
                    }
                    {rowMap == 1 &&
                        <Image source={gold} style={{position: 'absolute', top: rowMap == 1 ? -10 : -2, zIndex: 99, height: 57, width: 36,resizeMode:'stretch'}}></Image>
                    }
                    {rowMap == 2 &&
                        <Image source={bronze} style={{position: 'absolute', top: rowMap == 1 ? -25 : 40, zIndex: 99, height: 30, width: 30}}></Image>
                    }
					<ImageBackground source={{uri: item.user_details.profile_pic}} style={{
                            height: rowMap == 1 ? 95 : 70,
                            width: rowMap == 1 ? 95 : 70,
                            marginTop: rowMap == 1 ? 30 : 60,
                            shadowColor: 'gray',
						 ...
						 <View style={{alignItems: 'center', marginTop: 0, backgroundColor: 'transparent'}}>
                            <Text style={{
                                ...
                                marginRight: 2
                                  ...
                                  numberOfLines={1}>{item.user_details.name}1</Text>
        ...
        return this.state.FirstThreeSR.map((item, rowMap) => {
            return (
                <View style={{
                    ...
                    {rowMap == 1 &&
                        <Image source={gold} style={{position: 'absolute', top: rowMap == 1 ? -10 : -2, zIndex: 99, height: 57, width: 35,resizeMode:'stretch'}}></Image>
                    }
                    {rowMap == 2 &&
                        <Image source={bronze} style={{position: 'absolute', top: rowMap == 1 ? -25 : 40, zIndex: 99, height: 30, width: 30}}></Image>
                    }
