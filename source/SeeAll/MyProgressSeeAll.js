...
const injoycirclelogo = require('../../images/monthlyProgress.png');
...
export default class MyProgressSeeAll extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            weeklyActions: props.navigation.state.params.total_action_monthly,
            userPointsMonthly: 0,
            userPointsOverAll: 0,
            userFbProfile: null,
            overAllActions: props.navigation.state.params.total_action_overAll,
            checkInCount: 0
        };
    ...
    async componentDidMount() {
      ...
      var cntGraph = this.calculateMonthly(this.state.weeklyActions);
      var cntGraph1 = this.calculateOverall(this.state.overAllActions);
    ...
    calculateMonthly(weekly) {
      if(weekly <= 825) {
        var total = (weekly/825)*30;
        return total;
      }else if (weekly <= 1650) {
        var total = ((weekly/1650)*30)+30;
        return total;
      }else if (weekly <= 2475) {
        var total = ((weekly/2475)*40)+60;
        return total;
      }else {
        var total = 100;
        return total;
        ...
        return this.state.data_list.map((item,rowmap)=>{
            return(
                    ...
                    <View style={{
                        ...
                        ></ImageBackground>
                        <Text style={{marginTop: 5, fontFamily: 'PoppinsSemiBold', fontSize: 14, textAlign: 'center'}}>{this.returnTextMonthly(rowmap)}</Text>
                    </View>
        ...
        return this.state.data_list_overall.map((item,rowmap)=>{
            return(
                    ...
                    <View style={{
                        ...
                        ></ImageBackground>
                        <Text style={{marginTop: 5, fontFamily: 'PoppinsSemiBold', fontSize: 14, textAlign: 'center'}}>{this.returnTextOverall(rowmap)}</Text>
                    </View>
        ...
        return (
          <View style={{paddingHorizontal: 8, flex: 1}}>
              ...
              <View style={{
                  ...
                  <ImageBackground resizeMode='contain' style={{height: 90, width:'100%'}} source={injoycirclelogo}>
