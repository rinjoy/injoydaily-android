...
export default class AddReply extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            listViewData: Array(2)
                ...
                accessToken:'',
                challengeId:props.navigation.state.params.challengeID,
                itemCount: 0,
                feature_name: props.navigation.state.params.feature_array.feature_name,
                highCount: 0,
                total_count: 0,
                userLiked: false,
                profilePic: props.navigation.state.params.profile_pic,
                basic_array: props.navigation.state.params.basic_array,
                commentText: '',
                featureId:2,
                editIndex: '',
                editPost: {},
                linkedfeatureId: props.navigation.state.params.DATA.shout_out.id,
                week: props.navigation.state.params.basic_array.details.week,
                day: props.navigation.state.params.basic_array.details.day,
                offSet:0,offSetLoader:false,Alldata:props.navigation.state.params.DATA,
    ...
    componentDidMount() {
        ...
        console.log('asdaslkdj ljkd laksjd lkasjd la', this.state.Alldata);
 ...
 // alert(token_)
       var parameters = {
           ...
           linked_feature_id:this.state.linkedfeatureId,
           page_size:7,
              ...
              <View style={{backgroundColor:'transparent',flexDirection:'row',alignItems:'flex-start'}}>
                  ...
                  <View style={{flex: 0.85, backgroundColor:"transparent",  marginLeft:10}}>
                      ...
                      <View style={{backgroundColor: 'transparent', paddingLeft: 5, marginTop: 10, marginBottom: 10}}>
                         <Text style={{fontSize:13,fontFamily:'PoppinsRegular',color:'black',marginTop:0}}>{this.state.Alldata.shout_out.comment}</Text>
                      </View>
     ...
     // console.log(dataHolder)
            return(
                ...
                <View style={{marginRight: 0, marginBottom: 0,
                    ...
                    // shadowColor: "gray",
                    // shadowOpacity: 0.8,borderRadius:4,
                    // shadowRadius: 2,paddingHorizontal:3,
                    // paddingVertical: 8,
                    // shadowOffset: {
                    //     height: 1,
                    //     width: 1
    ...
    render() {
        return (
            ...
            <View style={{backgroundColor: '#fff', paddingBottom: 20, margin: 0}}>
              ...
              <KeyboardAvoidingView style={{ flex: 1, flexDirection: 'column', justifyContent: 'center',}} enabled  behavior='padding' keyboardVerticalOffset={0}>
              {this.state.offSetLoader &&
                    ...
                    <ImageBackground source={headerback} style={styles.header_image}>
                        ...
                        <View style={styles.header_items}>
                            ...
                            <View style={{
                                ...
                                <Text style={{fontFamily: 'PoppinsBold', fontSize: 18, color: '#fff'}}>{this.state.feature_name}
                                </Text>
                            </View>
                        </View>
                    </ImageBackground>
                ...
                {/* Ended Header View */}
                  ...
                  <View style={{flexDirection: 'row', flex: 1}}>
                      <View style={{flex: 0.13, backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'flex-start'}}>
