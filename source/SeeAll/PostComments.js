...
gallaryblack = require('../../images/cameraclick.png');
       ...
       // alert('in')
        ...
        this.state = {
            ...
            listViewData: Array(2)
                ...
                setImageHeight: 0,
                setImageWidth: 0,
                chDetails: props.navigation.state.params.challenge_details,
                challengeId:props.navigation.state.params.challenge_details.challenge_id,
                day: props.navigation.state.params.challenge_details.day,
                week: props.navigation.state.params.challenge_details.week,
                basicArray: props.navigation.state.params.basic_array,
                ...
                todayCount: 0,
                premiumModal1: false,
                profilePic: props.navigation.state.params.profile_pic,
                ...
                offSetLoader1:false,
                Alldata:props.navigation.state.params.DATA,
                imagetype:null,
                name:null,
                            ...
                            <Menu>
                              <MenuTrigger>
                                ...
                                <View style={{backgroundColor: 'transparent', paddingLeft: 10, justifyContent: 'center', alignItems: 'flex-end', paddingRight: 10}}>
                                  <Image source={dagger} style={{width: 6, height: 21,resizeMode:'stretch'}}>
                                  </Image>
                                </View>
            ...
            <View style={{backgroundColor: '#fff', paddingBottom: 20, margin: 0}}>
              <View style={{padding: 0}}>
                    ...
                    <View style={{padding: 15}}>
                      <Text style={{fontFamily: 'PoppinsSemiBold'}}>Why was this post flagged ?</Text>
                    </View>
                    <View style={{paddingHorizontal: 15}}>
                        <RNPickerSelect
                        onValueChange={value => {
          ...
          deviceHeight={deviceHeight} coverScreen={true} hasBackdrop = {false} isVisible={this.state.premiumModal} >
                    ...
                    <ImageBackground source={headerback} style={styles.header_image}>
                        ...
                        <View style={styles.header_items}>
                            ...
                            <View style={{
                                ...
                                <Text style={{fontFamily: 'PoppinsBold', color: '#fff', fontSize: 18}}>{this.state.Alldata.feature_name}
                                </Text>
                ...
                {!this.state.offSetLoader &&
                  ...
                  <View style={{flexDirection: 'row'}}>
                      ...
                      <View style={{flex: 0.82, backgroundColor: 'transparent', justifyContent: 'center',alignItems: 'center'}}>
                          <TextInput
                              ref="inputText"
                              multiline={true}
                              placeholder="Share something you're grateful for..."
                              placeholderTextColor = "#A0A0A0"
                              value={this.state.commentText1}
                              numberOfLines={3}
                              blurOnSubmit={true}
                              onSubmitEditing={Keyboard.dismiss}
                              onChangeText={(text) => this.setState({commentText1: text})}
                              style={{width: '100%', minHeight: 40, backgroundColor: '#F0F0F6', paddingHorizontal: 10,
                              elevation: 3,
                              textAlignVertical: "center",
                              shadowColor: "#000000",
                              ...
                              paddingTop: 10, paddingBottom: 10, borderRadius: 20}}
                              placeholderStyle={{fontFamily: 'PoppinsSemiBold', fontWeight: 'bold'}}
                          >
                          </TextInput>
                      </View>
                  </View>
                  <View style={{justifyContent: 'flex-end', backgroundColor: 'transparent', marginTop: 15}}>
                  <View style={{flexDirection: 'row', backgroundColor: 'transparent', width: '100%', marginRight: 0, alignItems: 'center', justifyContent: 'flex-start'}}>

                <View style={{width: '100%', flexDirection: 'row', marginTop: 0, backgroundColor: 'transparent`', justifyContent: 'center', alignItems: 'center'}}>
                <TouchableOpacity style={{width: '15%', backgroundColor: 'transparent'}}
                    ...
                    <View style={{
                        ...
                        <Image source={imageUrl != null ? {uri: imageUrl} : gallaryblack} style={{width: 40,
                        height: 40,
                        marginLeft: 0}}>
                        </Image>
                    </View>
