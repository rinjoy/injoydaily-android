...
export default class TermsConditions extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            htmlContent:'',
            profilePic: props.navigation.state.params.profilePic,
            isOpen: false,
            feature_url: global.base_url_live+'v1/api/get-terms-conditions-content-new'
        }
                    ...
                    {/* Header items View */}
                        <View style={styles.header_items}>
                            ...
                            <View style={{
                                ...
                                <Text style={{fontFamily: 'PoppinsBold', fontSize: 18, color:'#fff'}}> Terms and Conditions
                                </Text>
                            </View>
                            <View style={{width: '18%', backgroundColor: 'transparent'}}>
                                <TouchableOpacity
