...
export default class ModalUpdatePostReply extends Component {
  showActionSheet = () => {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            UID: '',
            week: props.week,
            editObject: props.updateContent,
            linked_feature_id: props.updateContent.shout_out.id,
            textInoutHint: '',
            buttonHint: '',
            buttonDisable: false,
            commentText: props.updateContent.shout_out.comment,
            AllData: '',
