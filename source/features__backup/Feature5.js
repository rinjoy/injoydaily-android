...
export default class Feature5 extends Component {
    ...
    <Text
        ...
        <Modal style={{marginLeft: 10, marginRight: 10, marginBottom: 0, marginTop: StatusBar.currentHeight}}
        transparent={true} deviceWidth={deviceWidth}
        deviceHeight={deviceHeight} coverScreen={true} hasBackdrop={false}
        isVisible={this.state.premiumModal}>
            <View style={{
            flex: 1,
                height: '100%',
                width: '100%',
    ...
    <ImageBackground resizeMode='contain' source={backg}
