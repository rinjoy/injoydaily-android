...
export default class Feature3 extends Component {
            ...
            return this.state.challengeArray.map((dataholder, index) => {
                return (
                    <View style={{flex: 1}}>
                        ...
                        {dataholder.feature_id == 1 &&

                        <View style={styles.challenge_view}>
                            <Image source={{uri: dataholder.daily_inspiration_category.image}}
                                   style={styles.chalenge_profile}>
                            </Image>

                            <View
                                style={{flexDirection: 'row', borderBottomLeftRadius: 10, borderBottomRightRadius: 10}}>
                        ...
                        <View style={styles.appreciatio_view}>
                            <View style={{height: 100}}>
                                ...
                                <Text style={{
                                    ...
                                    marginTop: 7,
                                    lineHeight: 23
                                }}>{dataholder.shout_out_category.title} </Text>
                                <Text style={{
                                    marginLeft: 15,
                                    marginTop: 5,
                                    color: '#19bffd',
                                ...
                                <View style={{height: 32, alignItems: 'flex-end', marginTop: -15}}>
                                    <Image source={unlockgray}
                                           style={{width: 30, height: 30, marginLeft: 15, marginRight: 8}}>
                                    </Image>
                                </View>
                                ...
                                <View style={{height: 290}}>
                                    <FlatList style={{marginTop: -20}}
                                              data={dataholder.shout_out_category.high_five}
                                              ...
                                              renderItem={({item, index}) =>
                                                  <View style={{
                                                      ...
                                                      marginLeft: 0,
                                                      marginTop: 12,
                                                      borderBottomWidth: index == dataholder.shout_out_category.high_five.length - 1 ? 0 : 0.2,
                                                      ...
                                                      <View style={{
                                                          ...
                                                          <Text
                                                              style={styles.appreciation_title}>{item.user_details.name}
                                                          </Text>
                                                          <Text style={styles.appreciation_desc}>{item.shout_out.time}
                                                          </Text>
                                                          <Text style={styles.appreciation_desc}
                                                                numberOfLines={1}>{item.shout_out.comment}
                                                          </Text>
                                                          ...
                                                          <View style={{
                                                              ...
                                                              <Text style={{
                                                                  fontSize: 13,
                                                                  marginRight: 5
                                                              }}> {item.shout_out.total_high_fives} </Text>

                                                              <Image source={commentblue}
                                                                     style={{width: 15, height: 15, marginLeft: 5}}>
                                                              </Image>
                                                              <Text
                                                                  style={{fontSize: 13}}> {item.shout_out.total_replies} </Text>
                                                          </View>
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <View style={{
                                    ...
                                    <View style={{flexDirection: 'row'}}>
                                        ...
                                        <Text
                                            style={{marginTop: 12, fontSize: 12, color: 'gray', marginLeft: 4}}> WEEKLY
                                            VIDEO
                                        </Text>
                                    </View>
                        ...
                        {dataholder.feature_id == 4 &&

                        <View style={styles.LeaderShipCorner}>
                            <View style={{backgroundColor: 'transparent', flex: 1}}>
                                ...
                                <View style={{backgroundColor: 'transparent', height: 20}}>
                                    <View style={{
                                        ...
                                        <Image source={checkgreen}
                                               style={{width: 18, height: 18, marginLeft: 6, marginTop: 0}}>
                                        </Image>

                                        <Text style={{
                                            marginTop: 0, marginLeft: 5, fontSize: 12,
                                            fontFamily: 'PoppinsBold', color: 'black',
                                        }}>{dataholder.feature_name.toUpperCase()}</Text>
                                    </View>
                                ...
                                <View style={{
                                    ...
                                    <View style={{flex: 1, backgroundColor: 'transaprent', flexDirection: 'row',}}>
                                        <Image
                                            source={{uri: dataholder.coach_corner_category.dashboard_image}}
                                            ...
                                            <View style={{flexDirection: 'row'}}>
                                                <Text style={{
                                                    ...
                                                    fontSize: 14,
                                                      ...
                                                      numberOfLines={2}
                                                >{dataholder.coach_corner_category.title + " |"}</Text>
                                                <Text style={{
                                                    fontFamily: 'PoppinsSemiBold',
                                                    color: 'black',
                                                    fontSize: 14,
                                                      ...
                                                      numberOfLines={1}
                                                >{dataholder.coach_corner_category.designation}</Text>
                                            </View>
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <View style={{
                                    ...
                                    <View style={{flexDirection: 'row'}}>
                                        ...
                                        <Text style={{marginTop: 12, marginLeft: 5, fontSize: 12, color: 'gray'}}> DAILY
                                            OATH
                                        </Text>
                                    </View>
                            ...
                            <View style={{flexDirection: 'row', height: 80}}>
                                <View style={{width: '90%'}}>
                                    <View style={{flexDirection: 'row'}}>
                                        ...
                                        <Text style={{marginTop: 12, marginLeft: 5, fontSize: 12, color: 'gray'}}>TODAY'S
                                            WIN
                                        </Text>
                                    </View>
                                ...
                                <View
                                    style={{width: '10%', height: 70, justifyContent: 'center', alignItems: 'center'}}>
                                    <Image source={nextarrow} style={{width: 10, height: 18, marginRight: 10}}>
                                    </Image>
                                </View>
                                              ...
                                              <View style={styles.win_user_itemsview}>
                                                  ...
                                                  <View style={{
                                                      ...
                                                      <View style={{
                                                          ...
                                                          <Image source={hands}
                                                                 style={{width: 13, height: 13, marginTop: 10}}>
                                                          </Image>
                                                          <Text style={{
                                                              fontFamily: 'PoppinsRegular',
                                                              fontSize: 10,
                            ...
                            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                <View style={{
                                    ...
                                    <View style={{flexDirection: 'row'}}>
                                        ...
                                        <Image source={checkgray}
                                               style={{width: 16, height: 16, marginLeft: 7, marginTop: 12}}>
                                        </Image>
    ...
    render() {
        return (
            <View>
              <Text>Feature 3 UI Please check ............</Text>
            </View>
