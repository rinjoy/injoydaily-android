    ...
    render() {
      ...
      if(this.state.leaderData.length !== 0) {
        return (
          ...
          onPress={()=>navigate('LeaderShipSecond', {uId:this.state.UID,week:this.state.week,day:this.state.day, cId: this.state.challenge_id, onGoBack: this.refresh, index: 0})}>
