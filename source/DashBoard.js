    ...
    componentWillReceiveProps(nextProps, nextContext) {
        if(nextProps.navigation.state.params !== undefined) {
            ...
            if((nextProps.navigation.state.params.user_name !== this.state.userName) && (nextProps.navigation.state.params.user_name !== undefined)) {
				if(nextProps.navigation.state.params.user_name != undefined){
					 var nameArr = nextProps.navigation.state.params.user_name.split(' ');
					 var addName = nameArr[0];
				}
				else{
					 var addName = this.state.userName;
				}
                ...
                <View style={{backgroundColor: 'white', marginBottom: 15, flexDirection: 'row'}}>
                    <View style={{backgroundColor: 'transparent', flex: 0.75}}>
                        ...
                        <View style={{
                            ...
                            <Text style={{fontSize: 11, fontFamily: 'PoppinsRegular', marginTop: 4,color:'#000'}}> {currentDate}</Text>
                        </View>
                    </View>
                    <View style={{
                        ...
                        {!this.state.paidStatus &&
                            <TouchableOpacity onPress={this.premium}>
                                <View style={{alignItems: 'center'}}>
                                    ...
                                    <Text style={{fontSize: 11, fontFamily: 'PoppinsRegular', marginTop: 4,color:'#000'}}>InJoy
                                        Premium </Text>
                                </View>
                            </TouchableOpacity>
                        }
                            ...
                            <View style={styles.tabbar_inner_view2}>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity style={{alignItems: 'center', marginTop: 5}}
                                        ...
                                        <Text style={{marginBottom: 2, fontFamily: 'PoppinsRegular', fontSize: 13,color:'#000'}}>
                                            Library </Text>
                                    </TouchableOpacity>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity style={{alignItems: 'center', marginTop: 5}}
                                        ...
                                        <Image source={user} style={{width: 24, height: 24, resizeMode: 'contain',color:'#000'}}>
                                        </Image>
